...
//roomProvider.userRooms[index].roomNameAr!
    return Scaffold(
      body: SafeArea(
        child: Directionality(
          ...
          child: Container(
            child: Column(
              ...
              children: [
                CustomAppBar(title: translator.translate("usersRooms")),
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(translator.currentLanguage == 'ar' ?roomProvider.userRooms[index].roomNameAr!:roomProvider.userRooms[index].roomName!,style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold),),
