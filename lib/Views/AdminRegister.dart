...
class _AdminState extends State<AdminRegister>{
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  Text(translator.translate('Create Admin Account'),style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 16),),
                    ...
                    child: Form(
                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                  ...
                                  hintText: translator.translate('Admin Name'),
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                  ...
                                  hintText: translator.translate('Admin Email'),
                                  hintStyle: TextStyle(color: Colors.white,fontSize: 14),
                                  fillColor: Colors.white
                              ),
                            ),
                          ...
                          //     mainAxisAlignment: MainAxisAlignment.center,
                          //     children: [
                          //       Text(translator.translate('Youhaveanaccount?'),style: TextStyle(fontSize: 12,color: Colors.white),),
                          //       Text(translator.translate('SignIn?'),style: TextStyle(fontSize: 12,color: Color(AppTheme.yellowColor)),)
                          //     ],
                          //   ),
                          // ),
