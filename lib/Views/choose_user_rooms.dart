...
import '../main.dart';
class ChooseRoomForUser extends StatefulWidget {
  const ChooseRoomForUser({Key? key}) : super(key: key);

  @override
  State<ChooseRoomForUser> createState() => _ChooseRoomForUserState();
}

class _ChooseRoomForUserState extends State<ChooseRoomForUser> {
  int select=-1;
  @override
    ...
    return Scaffold(
      ...
      body:Container(
        ...
        child: Column(
          ...
          children: [
            Text(translator.translate('Select Room For This User'),style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16,color: Color(AppTheme.yellowColor)),),
