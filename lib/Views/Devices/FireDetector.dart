...
class _state extends State<FireDetector>{
  int degree=5;
  @override
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(
                            ...
                            child: Text("Fire detector value",style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold),)),
                        FlutterSwitch(
                          height: 15.0,
                          width: 30.0,
                          padding: 4.0,
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(
                            width: MediaQuery.of(context).size.width*.43-30,
                            child: Text("Fire detector Event",style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold),)),
                        FlutterSwitch(
                          height: 15.0,
                          width: 30.0,
                          padding: 4.0,
            ...
            children: [
              Container(
                ...
                child: CircularPercentIndicator(
                  ...
                  children: [
                    Image.asset("assets/images/devices/fire-degree.png"
