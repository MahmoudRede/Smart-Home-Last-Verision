...
//           children: [
//             SizedBox(height: 35,),
//             CustomAppBar(title: translator.translate("Dinner Room")),
//             SizedBox(height: 10,),
//             Padding(
...
//                       onTap: (){
//                         // if(roomProvider.userDevices[index].deviceId==5){
//                         //   setState(() {
//                         //     _index=0;
//                         //   });
//                         // }
//                         // else if(roomProvider.userDevices[index].deviceId==6){
//                         //   setState(() {
//                         //     _index=1;
//                         //   });
//                         // }
//                         // else if(roomProvider.userDevices[index].deviceId==7){
//                         //   print(roomProvider.userDevices[index].deviceId);
//                         //   setState(() {
//                         //     _index=2;
//                         //   });
//                         // }
//                         // else if(roomProvider.userDevices[index].deviceId==8){
//                         //   setState(() {
//                         //     _index=3;
//                         //   });
//                         // }
//                         // else if(roomProvider.userDevices[index].deviceId==9){
//                         //   setState(() {
//                         //     _index=4;
//                         //   });
//                         // }
//                         // else if(roomProvider.userDevices[index].deviceId==10){
//                         //   setState(() {
//                         //     _index=5;
//                         //   });
//                         // }
//                         // else if(roomProvider.userDevices[index].deviceId==11){
//                         //   setState(() {
//                         //     _index=6;
//                         //   });
//                         // }
//                         // else if(roomProvider.userDevices[index].deviceId==12){
//                         //   setState(() {
//                         //     _index=7;
//                         //   });
//                         // }
//                         // else if(roomProvider.userDevices[index].deviceId==13){
//                         //   setState(() {
//                         //     _index=8;
//                         //   });
//                         // }
//                         // else if(roomProvider.userDevices[index].deviceId==14){
//                         //   setState(() {
//                         //     _index=9;
//                         //   });
//                         // }
...
//                         //   });
//                         // }
//                         // if(roomProvider.userDevices.length>0){
//                         //   setState(() {
...
//                         if(roomProvider.userDevices[index].deviceId==5){
//                           setState(() {
//                             deviceProvider.roomDevices[index].device.id=5;
//                             _index=0;
//                           });
//                         }
//                         else if(roomProvider.userDevices[index].deviceId==6){
//                           setState(() {
//                             deviceProvider.roomDevices[index].device.id=6;
//                             _index=1;
//                           });
//                         }
//                         else if(roomProvider.userDevices[index].deviceId==7){
...
//                           setState(() {
//                             deviceProvider.roomDevices[index].device.id=7;
//                             _index=2;
//                           });
//                         }
//                         else if(roomProvider.userDevices[index].deviceId==8){
//                           setState(() {
//                             deviceProvider.roomDevices[index].device.id=8;
//                             _index=3;
//                           });
//                         }
//                         else if(roomProvider.userDevices[index].deviceId==9){
//                           setState(() {
//                             deviceProvider.roomDevices[index].device.id=9;
//                             _index=4;
//                           });
//                         }
//                         else if(roomProvider.userDevices[index].deviceId==10){
//                           setState(() {
//                             deviceProvider.roomDevices[index].device.id=10;
//                             _index=5;
//                           });
//                         }
...
//                                    (roomProvider.userDevices[index].deviceLogo)!
//                                )),
//                                SizedBox(height: 25,),
//                                Text(roomProvider.userDevices[index].deviceName!),
//                              ],
//                         ),
//                       ),
//                     );
...
//                     );
//                   },
//                   itemCount: roomProvider.userDevices.length
//               ),
//             ),
//             SizedBox(height: 30,),
...
class UserRoomDivices extends StatefulWidget{
  int room_id;
  String name;
  int route;
  UserRoomDivices({required this.room_id,required this.name,required this.route});
  @override
  State<StatefulWidget> createState() {
    return _state(room_id: this.room_id,name: this.name);
  }
}
class _state extends State<UserRoomDivices>{
  int room_id;
  var name;
