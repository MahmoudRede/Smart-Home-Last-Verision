                      ...
                      child: Row(
                        ...
                        children: [
                          Container(
                              ...
                              child: Text(translator.translate('Smoke detector Switch'),style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold),)),
                          FlutterSwitch(
                            height: 15.0,
                            width: 30.0,
                            padding: 4.0,
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Container(
                              width: MediaQuery.of(context).size.width*.43-30,
                              child: Text(translator.translate('Smoke detector Event'),style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold),)),
                          FlutterSwitch(
                            height: 15.0,
                            width: 30.0,
                            padding: 4.0,
